        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <b-button v-b-modal.modal-3 variant="primary">Add Template</b-button>
        ...
        <form ref="form">
          ...
          >
            ...
            <b-form-input
                id="name-input"
                :state="nameState"
                v-model="payload.template_name"
                placeholder="Template Name"></b-form-input>
          </b-form-group>
          ...
          <b-form-group
              ...
              label="SMS Body"
              label-for="sms-body"
              invalid-feedback="SMS Body is required"
          >
            <b-textarea
                id="sms_body"
                :state="nameState"
                class="form-control" rows="3"
                v-model="payload.sms_body"
                placeholder="SMS Body"></b-textarea>
          </b-form-group>
...
export default {
  ...
  methods: {
    ...
    async confirmDelete() {
      await this.$store.dispatch('smsTemplate/deleteSmsTemplate', this.delete_id).then(result => {
        this.$toasted.show(result.message, {
          theme: 'outline',
          position: 'top-right',
          icon: result.code !== 200 ? `ThumbsDownIcon` : 'ThumbsUpIcon',
