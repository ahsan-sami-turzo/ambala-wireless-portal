<template>
  <div>
    <Breadcrumbs main="Report" title="All Delivery Report"/>
                ...
                <div class="row">
                  <div class="col-4">
                    ...
                    <div class="form-group">
                      <datepicker input-class="datepicker-here form-control digits"  @input="fromDate"></datepicker>
                    </div>
                  </div>
                  <div class="col-4">
                    <label class="f-w-600">End Date:</label>
                    <div class="form-group">
                      <datepicker input-class="datepicker-here form-control digits" @input="toDate"></datepicker>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
...
export default {
  ...
  watch: {
    ...
    deliveryReports(newValue, oldValue) {
        ...
        //console.log(this.deliveryReports)
  ...
  methods: {
    ...
    handleChangePage(page) {
      if(page>this.pageCount)
        this.$store.dispatch('deliveryReport/fetchDeliveryReportByPage', {count: this.perPage,from_date:this.from_date, to_date:this.to_date, page: page, status:this.status})
    },
