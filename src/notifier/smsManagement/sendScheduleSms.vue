<template>
  <div>
    <Breadcrumbs main="Messaging" title="Schedule SMS"/>
                  ...
                  <b-tab title="Single SMS" active>
                    <form @submit.prevent="">
                      <div class="row">
                        ...
                        <div class="col-md-12 mt-2">
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              ...
                              <b-form-input type="datetime-local" v-model="payload.schedule_time"></b-form-input>
                            </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group m-checkbox-inline custom-radio-ml">
                            <div class="checkbox checkbox-dark">
                              <b-form-checkbox name="checkbox7" v-model="payload.remove_duplicate">Remove Duplicate
                              </b-form-checkbox>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 mt-2">
                          <div class="form-group">
                            <label class="form-label">Enter SMS Content |<a v-b-modal.modal-3 class="primary ml-2">Use
                              Templates</a></label>
          ...
          <div class="col-xl-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <br>
<!--                <br>-->
<!--                <span class="font-primary">Upload File:</span> You can send SMS in bulk by uploading a list of contacts-->
<!--                in CSV format. Once the upload is-->
...
<!--                <br>-->
<!--                <br>-->
<!--                <span class="font-primary">Group SMS: </span> You can send SMS directly to your saved contact group.-->
<!--                Just select the group and type your-->
...
export default {
  ...
  methods: {
    ...
    async submitSms() {
      let time_date = this.payload.schedule_time.split("T")
      this.payload.schedule_time = time_date[0] + " " + time_date[1]
      await this.$store.dispatch('smsManage/addScheduleSmsSend', this.payload).then(result => {
